              ...
              child: Column(
                children: [
                  ...
                  CustomTextFormField(
                      validator: (value) {
                        if (value!.isEmpty) {
                          controller.titleEditingController.text = 'No Title';
                        }
                        return null;
                      },
                      hintText: 'Title',
        ...
        children: [
          DrawerHeader(
            ...
            child: GestureDetector(
              onLongPress: () async {
                if (controller.imageUrl != null && controller.imageUrl != '') {
              ...
              onTap: () async {
                if (controller.userHasInformation &&
                    controller.imageUrl == null) {
                  Get.toNamed(AppRoutes.imageScreen,
                      arguments: UserService.listUserModel[0].image.toString());
                } else {
                  Get.toNamed(AppRoutes.imageScreen,
              ...
              child: CircleAvatar(
                ...
                child: GetBuilder<HomeController>(
                  builder: (controller) => CircleAvatar(
                      radius: double.infinity,
                      backgroundImage: controller.userHasInformation &&
                              controller.imageUrl == null
                          ? Image.asset(
                                  UserService.listUserModel[0].image.toString())
                              .image
                          : NetworkImage(controller.imageUrl == null
                              ? controller.currentUser!.photoURL!
                              : controller.imageUrl!),
                      child: Column(
                ...
                child: FutureBuilder(
                  ...
                  builder: (BuildContext context, AsyncSnapshot snapshot) {
                    if (snapshot.hasData) {
                      return Text(
                        textScaleFactor: 1.2,
                        'Name: ${controller.userHasInformation ? snapshot.data[0].displayName : controller.currentUser?.displayName}',
